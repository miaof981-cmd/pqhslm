...
Page({
  ...
  async loadDashboard() {
    ...
    console.log(`  待支付: ${unpaidOrdersCount}个`)
    console.log(`  已支付: ${paidOrdersCount}个`)
    console.log(`  制作中: ${processingOrdersCount}个`)
    console.log(`  待确认: ${waitingOrdersCount}个`)
    console.log(`  临近截稿: ${nearDeadlineOrdersCount}个`)
